    ...
    public async Task<int?> GetAveragePriceByNeighbourhood(string neighbourhood)
    {
        try
        {
            ...
            else
            {
                ...
                await _distributedCache.SetStringAsync($"_avg_price_{neighbourhood}", cachedAveragePrice,
                    expiryOptions);
            }
    ...
    public async Task<PropertyTypesStats?> GetAmountPropertyTypes()
    {
        try
        {
            ...
            else
            {
                ...
                await _distributedCache.SetStringAsync("_amountPropertyTypes", cachedAmountPropertyTypes,
                    expiryOptions);
            }
            ...
            {
                if (t.PropertyType == null) continue;
